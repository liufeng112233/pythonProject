...
if __name__ == '__main__':
    file_path = 'F:/pythonProject/opencv_tools_main/images/000000507081.jpg'

    origin = cv2.imread(file_path)   # BGR
    origin = origin[:, :, [2, 1, 0]]    # RGB
    # cv2.imshow("origin",origin)   # 窗口打印图片
    # cv2.waitKey(0)
